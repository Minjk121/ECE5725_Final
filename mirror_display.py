...
space_list={'CIS lounge':'1','Duffield atrium':'1','ECE lounge':'1','Rhodes 3rd floor':'1','Rhodes 4th floor':'1','Rhodes 5th floor':'1', 'Upson 2nd floor':'1', 'Upson 3rd floor':'1'}
...
while (time.time() < end_time):
    ...
    # if (not GPIO.input(17)):
    #     pygame.image.save(screen, "./images/screenshot_2"+str(screenshot_num)+".jpeg")
